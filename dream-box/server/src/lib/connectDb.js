...
module.exports = async function ({ login, password, nameDataBase }, cb) {
  try {
    const link = `mongodb://127.0.0.1:27017/${nameDataBase}?authSource=admin`;
    //const link = `mongodb://${login}:${password}@cluster0.n6oze.mongodb.net/${nameDataBase}?retryWrites=true&w=majority`;
