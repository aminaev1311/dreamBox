<template>
  <nav class="menu-up">
    <ul class="menu-up__list">
      <!--      <menu-up-li
          v-for="(item,i) on items.weeks"
          :item="item"
          :className="className"
          ></menu-up-li> -->
      <li class="menu-up__item">
        <a href="" class="menu-up__item">week 1</a>
        <div class="box_week success-wk"></div>
      </li>
      <li class="menu-up__item">
        <a href="" class="menu-up__item">week 2</a>
        <div class="box_week failure-wk"></div>
      </li>
      <li class="menu-up__item">
      ...
      <li class="menu-up__item">
        ...
        <div class="box_week default-wk"></div>
      </li>
      <li class="menu-up__item">
      ...
      <li class="menu-up__item">
        <a href="" class="menu-up__item">week 11</a>
        <div class="box_week default-wk"></div>
      </li>
      <li class="menu-up__item">
        <a href="" class="menu-up__item">week 12</a>
        <div class="box_week default-wk"></div>
      </li>
    </ul>
  </nav>
  ...
  data() {
    return {
      items: {
        ...
        className: ["success-wk", "default-wk", "failure-wk"],
      },
    };
  },
};
...
.menu-up {
  ...
  .success-wk {
    background-color: $color-week-sc;
  }
  .default-wk {
    background-color: $color-week-df;
  }
  .failure-wk {
    background-color: $color-week-fl;
  }
}
</style>
